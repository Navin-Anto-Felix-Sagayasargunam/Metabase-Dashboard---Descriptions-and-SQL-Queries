...
-- Dashboard ID: 50
-- Chart: Active Linked Users Previous 30 days
-- Card ID: 259
-- Query Type: native
-- Database ID: 2
...
SELECT
    ...
    END AS active_linked_users_30d
FROM sessions_v4 AS s
JOIN account_logins_v4 AS a
  ON s.customer_id = a.customer_id
WHERE 
    ((
    s.last_activity_date::Date >= TO_CHAR(CURRENT_DATE - INTERVAL '30 day', 'YYYY-MM-DD') --CURRENT_DATE - INTERVAL '30 day'
    ...
    (
        (
  TO_TIMESTAMP(s.created_at, 'YYYY-MM-DD"T"HH24:MI:SS.MS')::date >= TO_CHAR(CURRENT_DATE - INTERVAL '30 day', 'YYYY-MM-DD')
